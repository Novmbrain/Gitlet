 ...
 * @className: IHandler
 * @description:
 * 1. Handler1 : Modified in other but not HEAD → Other, stage for addition
...
public abstract class Handler {
  protected abstract boolean doHandle(String fileName, Commit headCommit, Commit givenCommit, Commit splitPointCommit, Repository repository);

  public final boolean handle(String fileName, Commit headCommit, Commit givenCommit, Commit splitPointCommit, Repository repository) {
    return doHandle(fileName, headCommit, givenCommit, splitPointCommit, repository);
  }
}